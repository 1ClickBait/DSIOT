...
*/
bool sendLoRaFrame(float temperature, float pressure, float humidity, float gas_resistance, float iaq, float dew_point, float discomfort_index, float heat_index)
{
  ...
  uint8_t buffSize = 0;
    ...
    uint16_t press = pressure; // Already in hPa
    uint16_t gas = gas_resistance / 100;
    uint16_t iaqVal = iaq * 100;
    uint16_t dp = dew_point * 100;
    uint16_t di = discomfort_index * 100;
    uint16_t hi = heat_index * 100;
    ...
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(temp >> 8);
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(temp);
    ...
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(hum >> 8);
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(hum);
    ...
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(press >> 8);
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(press);
    ...
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(gas >> 8);
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(gas);
    ...
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(iaqVal >> 8);
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(iaqVal);
    ...
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(dp >> 8);
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(dp);
    ...
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(di >> 8);
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(di);
    ...
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(hi >> 8);
    m_lora_app_data_buffer[buffSize++] = (uint8_t)(hi);
